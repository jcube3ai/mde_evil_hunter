...
function Hunt-Masquerading {
    ...
    $suspLocations = @("C:\ProgramData","C:\Windows\Temp","C:\Users\Public") + (Get-VHUserPaths 'AppData\Local\Temp') + (Get-VHUserPaths 'Downloads')
...
function Hunt-Timestomping {
    ...
    $suspPaths = @("C:\ProgramData","C:\Windows\Temp") + (Get-VHUserPaths 'AppData\Local\Temp') + (Get-VHUserPaths 'Downloads')
